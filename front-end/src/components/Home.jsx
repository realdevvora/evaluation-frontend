  ...
  return (
    <div className="home--page">
      <div className="home--hero">
        <h3>Get the inside scoop on the courses you’re eyeing</h3>
      </div>
        <div className="home--review--example">
        <h3>View ratings for courses you plan to take:</h3>
        ...
        <div className="home--review--anecdote">
          <h3>Take courses that enable you to explore niche fields 🔎, growing industries 📈, or stimulate your passion for learning 🧠</h3>
          <img src={review_anecdotes} alt="" />
        </div>
        <div className="home--review--promotion">
          {/* <h3>Encourage others to take courses that will help them grow their academic and professional journey 🤝</h3> */}
        </div>
    </div>
  )
}
